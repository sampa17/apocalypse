...
import apocalypse.item.CaoutchoucItem;

import apocalypse.ApocalypseModElements;

@ApocalypseModElements.ModElement.Tag
public class FleurBlock extends ApocalypseModElements.ModElement {
	@ObjectHolder("apocalypse:fleur")
	public static final Block block = null;
	public FleurBlock(ApocalypseModElements instance) {
		super(instance, 8);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CaoutchoucItem.block, (int) (1)));
		}
