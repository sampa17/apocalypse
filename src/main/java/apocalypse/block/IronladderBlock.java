...
public class IronladderBlock extends ApocalypseModElements.ModElement {
	@ObjectHolder("apocalypse:ironladder")
	public static final Block block = null;
	public IronladderBlock(ApocalypseModElements instance) {
		super(instance, 21);
	}
