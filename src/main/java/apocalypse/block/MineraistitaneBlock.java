...
public class MineraistitaneBlock extends ApocalypseModElements.ModElement {
	@ObjectHolder("apocalypse:mineraistitane")
	public static final Block block = null;
	public MineraistitaneBlock(ApocalypseModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mineraistitane");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("mineraistitane", "mineraistitane", blockAt -> {
