...
public class Japalenofleur2Block extends ApocalypseModElements.ModElement {
	@ObjectHolder("apocalypse:japalenofleur_2")
	public static final Block block = null;
	public Japalenofleur2Block(ApocalypseModElements instance) {
		super(instance, 10);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("japalenofleur_2");
		}
