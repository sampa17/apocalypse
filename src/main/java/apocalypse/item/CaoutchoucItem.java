...
public class CaoutchoucItem extends ApocalypseModElements.ModElement {
	@ObjectHolder("apocalypse:caoutchouc")
	public static final Item block = null;
	public CaoutchoucItem(ApocalypseModElements instance) {
		super(instance, 8);
	}
