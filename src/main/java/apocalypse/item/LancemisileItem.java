...
import apocalypse.procedures.LancemisileBulletHitsBlockProcedure;
...
public class LancemisileItem extends ApocalypseModElements.ModElement {
	@ObjectHolder("apocalypse:lancemisile")
	public static final Item block = null;
	@ObjectHolder("apocalypse:entitybulletlancemisile")
	public static final EntityType arrow = null;
	public LancemisileItem(ApocalypseModElements instance) {
		super(instance, 15);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletlancemisile").setRegistryName("entitybulletlancemisile"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ApocItemGroup.tab).maxDamage(100));
			setRegistryName("lancemisile");
		}
			...
			if (this.inGround) {
				{
					...
					LancemisileBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
	...
	public static class CustomRender extends EntityRenderer<ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("apocalypse:textures/n.png");
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("apocalypse:missile")),
